...
urlpatterns = [
    ...
    path('animal/<int:animal_id>/weather/', views.weather_data, name='weather_data'),
    path('animal/<int:animal_id>/predict/', views.predict_location, name='predict_location'),
    ...
    path('api/animal-status/<int:animal_id>/', views.api_animal_status, name='api_animal_status'),
    path('api/locations/<int:animal_id>/', views.api_locations, name='api_locations'),
    path('api/weather/<int:animal_id>/', views.get_weather, name='get_weather'),
    path('api/predict/<int:animal_id>/', views.api_prediction_json, name='api_prediction_json'),
    path('api/vitals-stream/<int:animal_id>/', views.vitals_stream, name='vitals_stream'),
